    ...
    <div className="min-h-screen bg-[#f3f2ee] text-[#103b2d] font-serif">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className="text-5xl tracking-[0.3em] font-bold">
                  上島銀行
                </h1>

                <p className="text-lg tracking-[0.5em] mt-2 text-[#d7e6dd]">
                  NOMONEY
                </p>
              </div>
            </div>
            ...
            <p className="text-lg text-[#d7e6dd] leading-8 max-w-xl">
              ...
              模型制作、都市提案、プレゼンボード設計まで、
              あらゆるプロジェクトを金融の視点から支えます。
            </p>
          ...
          <div className="relative h-[500px] rounded-[40px] overflow-hidden">
            ...
            {/* 外側の白線 */}
            <div className="absolute inset-0 border border-white/20 rounded-[40px] z-20 pointer-events-none" />
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <p className="tracking-[0.4em] text-sm text-[#456457] mb-4">
            SERVICES
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* カード1 */}
          <div className="bg-white rounded-[32px] p-10 shadow-xl border border-[#d7d7d7] hover:-translate-y-2 transition">
            ...
            <p className="leading-8 text-[#355347]">
              模型材料費・印刷費・展示制作費など、
              建築学生特有のコストをサポート。
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-[#f3f2ee] rounded-[40px] p-8 shadow-2xl border border-[#d9d4c8]">
            ...
            <div className="flex justify-between items-center">
              <div>
                <p className="text-sm tracking-[0.3em] text-[#456457]">
                  SPONSORED BY
                </p>
      ...
      <footer className="bg-[#0d3b2e] text-white py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div>
            <h5 className="text-3xl tracking-[0.3em]">
              上島銀行
            </h5>

            <p className="text-[#d7e6dd] mt-2 tracking-[0.4em]">
              NOMONEY
            </p>
          </div>

          <div className="text-[#d7e6dd] text-sm tracking-[0.2em] text-center md:text-right">
            FICTIONAL ARCHITECTURAL PROJECT
            <br />
            © 2026 KAMISHIMA BANK
          </div>
        </div>
